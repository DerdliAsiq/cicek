...
var tl = gsap.timeline()
  ...
  // buds
  .fromTo(budGroup1, {autoAlpha: 1, scale: 0, transformOrigin: gsap.utils.wrap(['220% -10%', '55% 100%'])}, {duration:2, scale: 1, stagger: 2}, 'flower1')
  .fromTo(budGroup2, {autoAlpha: 1, scale: 0, transformOrigin: gsap.utils.wrap(['10% 30%', '65% 20%'])}, {duration:2, scale: 1, stagger: 2}, 'flower2')
  .fromTo(budGroup3, {autoAlpha: 1, scale: 0, transformOrigin: gsap.utils.wrap(['10% 30%', '65% 20%', '10% 20%', '10% 10%'])}, {duration:2, scale: 1, stagger: 2}, 'flower2')
  .fromTo(budGroup4, {autoAlpha: 1, scale: 0, transformOrigin: gsap.utils.wrap(['10% 30%', '65% 20%', '10% 20%', '10% 10%'])}, {duration:2, scale: 1, stagger: 2}, 'flower2')
  .fromTo(budGroup5, {autoAlpha: 1, scale: 0, transformOrigin: gsap.utils.wrap(['10% 30%', '55% 10%'])}, {duration:2, scale: 1, stagger: 2}, 'flower3')

  // dots scale animation
  .fromTo(dots, {scale: 0, transformOrigin: '50% 50%'}, {duration:5, scale: 1, ease: "expo.out"}, 'flower3');
